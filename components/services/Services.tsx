                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className={`text-center mb-20 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        ...
                        <p className="text-xl md:text-2xl text-white/70 max-w-4xl mx-auto leading-relaxed mb-12">
                            Full-stack development & modern web design solutions tailored to
                            <span className="text-purple-300 font-semibold"> scale your business </span>
                            and <span className="text-pink-300 font-semibold">delight your users</span>
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {services.map((service, index) => {
                                ...
                                return (
                                    <div
                                        key={service.id}
                                        className={`group relative backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all duration-700 hover:scale-105 hover:-translate-y-2 ${service.popular ? 'ring-2 ring-pink-500/30 shadow-2xl shadow-pink-500/10' : ''
                                            }`}
