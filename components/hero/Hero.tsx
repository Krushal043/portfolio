                        ...
                        <div className="relative group">
                            ...
                            <div className="relative inline-flex items-center space-x-2 sm:space-x-3 px-4 sm:px-6 py-2 sm:py-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full hover:bg-white/15 transition-all duration-300">
                                <div className="flex items-center space-x-1 sm:space-x-2">
                                    <FiCode className="w-4 h-4 sm:w-5 sm:h-5 text-purple-400 animate-pulse" />
                                    <FiLayers className="w-3 h-3 sm:w-4 sm:h-4 text-pink-400" />
                                </div>
                                <span className="text-white/90 text-xs sm:text-sm font-semibold tracking-wide text-center">
                                    <span className="hidden sm:inline">Full-Stack Developer | UI/UX Designer | Engineering Scalable, High-Performance Web Experiences</span>
                                    <span className="sm:hidden">Full-Stack Developer</span>
                                </span>
                                <div className="flex items-center space-x-1 sm:space-x-2">
                                    <FiTerminal className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400" />
                                    <FiZap className="w-3 h-3 sm:w-4 sm:h-4 text-pink-400 animate-pulse" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="relative">
                                <h1 className={`text-5xl sm:text-6xl lg:text-7xl xl:text-8xl leading-tight font-black tracking-tight transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                        ...
                        <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                            ...
                            <p className="text-lg sm:text-xl lg:text-2xl text-white/80 leading-relaxed font-light relative">
                                <span className="relative z-10">
                                    Engineering high-performance digital solutions through
                                    <span className="text-purple-300 font-semibold"> scalable full-stack systems</span>,
                                    <span className="text-pink-300 font-semibold"> responsive frontend architecture</span>,
