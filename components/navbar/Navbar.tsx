...
export default function Navbar() {
  ...
  const handleResumeDownload = () => {
    const resumeUrl = "/Kushal_Sojitra_5_years_Web_developer.pdf";
    const link = document.createElement("a");
    link.href = resumeUrl;
    link.download = "Kushal_Sojitra_5_years_Web_developer.pdf";
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4">
        <div
          className={`max-w-7xl mx-auto ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
          <div
            className={`
          ...
          >
            {/* Logo/Brand */}
            <div
              className="flex items-center space-x-2 z-20 cursor-pointer"
            ...
            <div className="flex items-center space-x-4 lg:hidden">
              ...
              >
                <div className="relative w-6 h-6 flex items-center justify-center">
                  {!isOpen ? (
                    <span
                      className={`block transition-all duration-300 ${isOpen ? "" : "-translate-y-0.5"}`}
                    >
                      <FiMenu size={24} />
                    </span>
                  ) : (
                ...
                <li key={item.id}>
                  <button
                    ...
                    style={{
                      ...
                      animation: isOpen
                        ? "mobileMenuSlide 0.6s ease-out forwards"
                        : "none",
                      opacity: 0,
