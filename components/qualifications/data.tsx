...
export const qualificationsInfos: QualificationsInfo[] = [
  {
    ...
    description:
      "Building modern, responsive web applications using React, TypeScript, and Node.js. Collaborating with cross-functional teams to deliver high-quality digital solutions.",
  ...
  },
  {
    ...
    description:
      "Developed full-stack features using MERN stack. Implemented RESTful APIs, optimized database queries, and improved application performance.",
  ...
  },
  {
    ...
    description:
      "Crafted pixel-perfect UIs with React and Tailwind CSS. Enhanced user experience through animations and responsive design principles.",
  ...
  },
  {
    ...
    description:
      "Crafted intuitive, visually appealing website designs with Figma and Adobe XD. Transformed UI mockups into responsive, pixel-perfect HTML/CSS codebases.",
