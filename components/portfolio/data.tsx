...
export const categories = [
  {
    ...
    description:
      "Explore every project I've built, from concept to deployment, across all domains and technologies.",
  },
  {
    name: "Featured",
    title: "Featured",
  ...
  },
  {
    ...
    description:
      "Full-stack web applications built with modern frameworks, delivering seamless user experiences and robust functionality.",
  },
  {
    name: "E-Commerce",
    ...
    description:
      "Secure, scalable e-commerce solutions with payment integration, inventory management, and personalized shopping flows.",
  },
  {
    name: "Sports",
    ...
    description:
      "Applications for sports analytics, fan engagement, training tools, and live event experiences.",
  },
  {
    name: "UI/UX",
    title: "UI/UX Design",
    ...
    description:
      "Beautiful, intuitive interfaces and user experiences crafted with attention to accessibility, usability, and visual storytelling.",
  },
  {
    name: "Gaming",
    ...
    description:
      "Engaging games and gaming platforms with immersive graphics, real-time multiplayer, and creative gameplay mechanics.",
  },
  {
    name: "Clones",
    ...
    description:
      "Replicated popular websites and applications to demonstrate technical skills and design understanding.",
  },
];
...
export const projects: Projects[] = [
  ...
  // },
  {
    ...
    role: [
      {
        id: 5001,
        info: "Team Collaboration: Worked in a team of 8 developers, including UI designers, backend developers, QAs, and fellow front-end developers.",
      },
      {
        id: 5002,
        info: "Development and Design: Lead frontend development, constructing and designing reusable components and pages, ensuring full responsiveness in alignment with Figma designs.",
      },
      {
        id: 5003,
        info: "API Integration: Successfully integrated Rest APIs for CricTracker website, enabling smooth data handling and user experience.",
      },
      {
        id: 5004,
        info: "Bug Fixing: Debugged existing code and fixed issues to enhance the performance and reliability of the website.",
      },
      {
        id: 5005,
        info: "Performance Optimization: Enhanced Core Web Vitals and Page Speed Score, ensuring fast load times for users.",
      },
      {
        id: 5006,
        info: "Client Communication: Engaged with clients to gather feedback, ensure timely delivery, and align project outcomes with their business goals.",
      },
    ],
    tech: [
  ...
  // },
  {
    ...
    role: [
      {
        id: 4001,
        info: "Team Collaboration: Worked collaboratively in a team of 10 developers, comprising UI designers, backend developers, QAs, and fellow front-end developers.",
      },
      {
        id: 4002,
        info: "Development and Design: Lead frontend development, constructing and designed reusable components and pages, ensuring full responsiveness in alignment with Figma designs.",
      },
      {
        id: 4003,
        info: "Project Leadership: As Lead Frontend Developer, actively contributed to the 999Tee Website and Admin Panel, overseeing the design and development of components, pages, and handling API integration for both.",
      },
      {
        id: 4004,
        info: "API Integration: Successfully integrated Rest APIs, facilitating seamless data exchange to enhance the platform's capabilities.",
      },
      {
        id: 4005,
        info: "Performance Optimization: Worked on enhancing Core Web Vitals and Page Speed Score, optimizing the website's performance.",
      },
      {
        id: 4006,
        info: "Client Communication: Acted as a liaison between the client and the development team, ensuring that client requirements were understood and incorporated into the project.",
      },
    ],
    tech: [
  ...
  // },
  {
    ...
    role: [
      {
        id: 6001,
        info: "Team Collaboration: Part of an 8-member team, working closely with UI designers, backend developers, and fellow front-end developers.",
      },
      {
        id: 6002,
        info: "Development and Design: Designed and constructed reusable components and pages, adhering to Figma designs and ensuring responsiveness.",
      },
      {
        id: 6003,
        info: "Actively contributed to both the SportsBuzz Website and Admin Panel, taking charge of designing components, pages, and API integration.",
      },
      {
        id: 6004,
        info: "Team Communication: Engaged in daily team calls and stand-up meetings on Slack to foster collaboration and project progress.",
      },
      {
        id: 6005,
        info: "Junior Developer Management: Managed Junior Developer's Pull Requests on GitHub, ensuring a smooth integration process by merging them into various deployment repositories.",
      },
      {
        id: 6006,
        info: "Performance Optimization: Built and maintained AMP (Accelerated Mobile Pages) to enhance the mobile user experience.",
      },
      {
        id: 6007,
        info: "Worked on improving Core Web Vitals and Page Speed Score, optimizing the website's overall performance.",
      },
      {
        id: 6008,
        info: "Project and Task Management: Utilized Jira for project and task sprint management, aiding in efficient project organization.",
      },
      {
        id: 6009,
        info: "Assigned tasks to junior front-end developers according to sprint objectives, playing an active role in debugging, bug fixing, and deploying the project on different servers for accessibility.",
      },
    ],
    tech: [
  ...
  },
  {
    ...
    role: [
      {
        id: 7001,
        info: "Team Collaboration: Collaborated with a team of 8 members, including a UI designer, backend developers, and front-end developers.",
      },
      {
        id: 7002,
        info: "Development and Design: Constructed and designed reusable components and pages, ensuring full responsiveness in alignment with Figma designs.",
      },
      {
        id: 7003,
        info: "Handled both frontend and backend development for the K L Bajoria College Website, including designing UI components, building pages, and implementing API integrations and server-side logic for seamless functionality.",
      },
      {
        id: 7004,
        info: "API Integration: Successfully integrated Rest APIs, facilitating seamless data exchange to enhance the platform's capabilities.",
      ...
      {
        id: 7005,
        info: "Project Management: Played a pivotal role in debugging, bug fixing, and deploying the project on various servers, including Development, Staging, and Production, ensuring optimal performance and accessibility.",
      },
      {
        id: 7006,
        info: "Performance Optimization: Worked on enhancing Core Web Vitals and Page Speed Score, optimizing the website's performance.",
      ...
      {
        id: 7007,
        info: "Client Communication: Actively communicated with clients to understand their requirements and provided regular updates on project progress, ensuring alignment with expectations.",
      },
    ],
    tech: [
  ...
  },
  {
    ...
    role: [
      {
        id: 8001,
        info: "Frontend Development: Developed and implemented responsive and user-friendly interfaces, ensuring a seamless user experience.",
      },
      {
        id: 8002,
        info: "UI/UX Design: Crafted intuitive wireframes, prototypes, and high-fidelity designs in Figma to enhance user engagement and accessibility.",
      },
      {
        id: 8003,
        info: "State Management: Implemented efficient state handling using React hooks and Context API for scalable data flow.",
      },
      {
        id: 8004,
        info: "Performance Optimization: Optimized rendering and bundle size to achieve fast load times and smooth interactions.",
      },
      {
        id: 8005,
        info: "Version Control: Managed code versioning, branching, and collaboration workflows using Git and GitHub.",
      },
      {
        id: 8006,
        info: "Responsive Design: Ensured cross-device compatibility with Bootstrap and custom CSS media queries.",
      },
      {
        id: 8007,
        info: "Backend Integration: Connected frontend with .NET APIs for real-time data synchronization and CRUD operations.",
      },
    ],
    tech: [
  ...
  },
  {
    ...
    role: [
      ...
      {
        id: 9002,
        info: "Interactive Prototyping: Built clickable prototypes in Figma to validate user flows and gather stakeholder feedback.",
      },
      {
        id: 9003,
        info: "Form Validation & Logic: Engineered robust client-side validation and link processing logic using JavaScript.",
      },
      {
        id: 9004,
        info: "SEO Optimization: Applied best practices for performance and accessibility to improve search visibility.",
      },
      {
        id: 9005,
        info: "Collaboration & CI/CD: Set up GitHub Actions for automated testing and deployment pipelines.",
      },
      {
        id: 9006,
        info: "Styling Framework: Leveraged Bootstrap for rapid, consistent, and mobile-first styling across components.",
      },
      {
        id: 9007,
        info: "API Consumption: Integrated .NET backend services for secure data handling and link replacement operations.",
      },
    ],
    tech: [
  ...
  },
  {
    ...
    role: [
      ...
      {
        id: 10002,
        info: "Component Architecture: Designed reusable React components with Tailwind for rapid UI iteration.",
      },
      {
        id: 10003,
        info: "Real-time Features: Implemented WebSocket connections for live game updates and multiplayer interactions.",
      },
      {
        id: 10004,
        info: "Animation & UX: Added micro-interactions and transitions to elevate the gaming immersion.",
      },
      {
        id: 10005,
        info: "Code Review & Collaboration: Conducted peer reviews and maintained clean Git history on GitHub.",
      },
      {
        id: 10006,
        info: "Performance Tuning: Optimized asset loading and lazy-loading strategies for fast game startup.",
      },
      {
        id: 10007,
        info: "Accessibility Compliance: Ensured WCAG standards for inclusive gameplay across devices.",
      },
    ],
    tech: [
  ...
  },
  {
    ...
    role: [
      ...
      {
        id: 11002,
        info: "NFT Marketplace UI: Built gallery views, minting flows, and wallet connection modals with React.",
      },
      {
        id: 11003,
        info: "Tailwind Styling: Created a modern, dark-mode compatible design system using utility-first CSS.",
      },
      {
        id: 11004,
        info: "Blockchain Integration: Connected to Web3 providers for wallet authentication and transaction handling.",
      },
      {
        id: 11005,
        info: "Testing & QA: Wrote unit tests with Jest and end-to-end tests with Cypress for reliability.",
      },
      {
        id: 11006,
        info: "Deployment Pipeline: Configured GitHub Pages and Vercel for continuous deployment.",
      },
      {
        id: 11007,
        info: "Analytics Tracking: Integrated event tracking for user behavior and conversion optimization.",
      },
    ],
    tech: [
