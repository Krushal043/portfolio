...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    setTimeout(() => {
      ...
      emailjs
        .sendForm("service_ypw4kzb", "template_2t3w93p", form.current, {
          publicKey: "vk9jmd2z3kYabxl7F",
        })
          ...
          <div className="contact__info">
            {contacts?.map((contact) => (
              <div className="contact__card" key={contact?.id}>
                <i className={`${contact?.icon} contact__card-icon`}></i>
                <h3 className="contact__card-title">{contact?.contact}</h3>
